...
class TestLiteLLMAPI:
    ...
    def test_chat_completions_missing_model(self) -> None:
    ...
    def test_chat_completions_invalid_request(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_chat_completions_mock(self, monkeypatch: Any) -> None:
    ...
    def test_chat_completions_streaming_request(self) -> None:
