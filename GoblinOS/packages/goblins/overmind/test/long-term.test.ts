...
describe('LongTermMemory', () => {
  ...
  describe('Memory operations', () => {
    it('should add and retrieve a memory', () => {
      ...
      expect(retrieved?.content).toBe('Kubernetes is a container orchestration platform')
    ...
    it('should filter by importance', () => {
      ...
      const results = memory.searchMemories({ importance: MemoryImportance.CRITICAL })
