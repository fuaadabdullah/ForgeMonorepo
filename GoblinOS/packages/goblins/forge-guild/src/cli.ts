 ...
 * 🧠 Smithy Brain CLI
 *
 * A command-line interface for interacting with the Smithy Brain.
 * Allows triggering scaffolding tasks and testing brain functionality.
 *
 * @module @goblinos/forge-guild/cli
 */
...
const logger = createLogger('smithy-cli')
...
program.name('smithy-cli').description('CLI for interacting with the Smithy Brain system.')
