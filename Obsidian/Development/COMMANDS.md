...
# Pipelines
smithy pipeline templates        # Show available pipeline blueprints
smithy pipeline generate python-ci python-ci.yml
smithy pipeline generate release release.yml --envs staging,production
