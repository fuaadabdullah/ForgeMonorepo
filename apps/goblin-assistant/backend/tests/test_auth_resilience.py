...
pytest.skip(
    "Legacy auth resilience suite depends on deprecated challenge-store APIs.",
    allow_module_level=True,
)

from auth.challenge_store import RedisChallengeStore, InMemoryChallengeStore as MemoryChallengeStore
