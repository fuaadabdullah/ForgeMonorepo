...
const SearchView = ({ state }: SearchViewProps) => (
  <div className="min-h-screen bg-bg py-12 px-4">
    <Seo title="Search" description="Search across your Goblin Assistant workspace." robots="noindex,nofollow" />
    <main className="max-w-3xl mx-auto" id="main-content" tabIndex={-1} aria-label="Search">
      <SearchHeader
        title="Global Search"
        subtitle="Search across documents, messages, and tasks with one query."
      />
