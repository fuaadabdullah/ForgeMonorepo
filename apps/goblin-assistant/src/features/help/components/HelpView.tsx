...
const HelpView = ({ form, startupFailure }: HelpViewProps) => (
  <div className="min-h-screen bg-bg">
    <Seo title="Help" description="Help Center for Goblin Assistant." robots="index,follow" />
    <main className="max-w-5xl mx-auto p-6 space-y-6" id="main-content" tabIndex={-1}>
      <header>
        <h1 className="text-3xl font-semibold text-text">Help Center</h1>
        <p className="text-sm text-muted">
          Find answers fast or start a support chat.
        </p>
      </header>
