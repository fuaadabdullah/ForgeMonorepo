...
let mockParseOrchestration: jest.SpyInstance;
let mockExecuteTaskStreaming: jest.SpyInstance;
let mockExecuteTask: jest.SpyInstance;
let mockDemoParseOrchestration: jest.SpyInstance;
let mockDemoExecuteTaskStreaming: jest.SpyInstance;
let mockDemoExecuteTask: jest.SpyInstance;

describe('GoblinDemo', () => {
  beforeEach(() => {
    jest.restoreAllMocks();

    mockParseOrchestration = jest.spyOn(runtimeClient, 'parseOrchestration').mockResolvedValue({
      steps: [
        {
          id: 'step1',
          goblin: 'docs-writer',
    ...
    mockExecuteTaskStreaming = jest.spyOn(runtimeClient, 'executeTaskStreaming').mockImplementation(
      async (
        _goblin: string,
        _task: string,
    ...
    mockExecuteTask = jest.spyOn(runtimeClient, 'executeTask').mockResolvedValue('Fallback result');

    mockDemoParseOrchestration = jest.spyOn(runtimeClientDemo, 'parseOrchestration').mockResolvedValue({
      steps: [
        {
          id: 'step1',
          goblin: 'docs-writer',
    ...
    mockDemoExecuteTaskStreaming = jest
      .spyOn(runtimeClientDemo, 'executeTaskStreaming')
      .mockImplementation(
      async (
        _goblin: string,
        _task: string,
    ...
    mockDemoExecuteTask = jest
      .spyOn(runtimeClientDemo, 'executeTask')
      .mockResolvedValue('Demo fallback result');
  });
